...
Подтвердить?
        ...
        'error_repost_caption_too_long_alert': "❌ Подпись слишком длинная ({current_length}/{max_length})! Сократите перед сменой типа.",
        'error_mediagroup_caption_limit_alert': "❌ Превышен лимит текста для сообщений с несколькими фото/видео файлами",
        'error_single_media_caption_limit_alert': "❌ Подпись к медиа слишком длинная (макс. 1024). Сократите перед сменой типа.",
...
''',
        ...
        'error_repost_caption_too_long_alert': "❌ Caption too long ({current_length}/{max_length})! Shorten before changing type.",
        'error_mediagroup_caption_limit_alert': "❌ Caption limit exceeded for messages with multiple photo/video files",
        'error_single_media_caption_limit_alert': "❌ Media caption too long (max 1024). Shorten before changing type.",
...
''',
        ...
        'error_repost_caption_too_long_alert': "❌ Pie de foto demasiado largo ({current_length}/{max_length})! Acorta antes de cambiar.",
        'error_mediagroup_caption_limit_alert': "❌ Límite de caption excedido para mensajes con múltiples fotos/videos",
        'error_single_media_caption_limit_alert': "❌ Caption de media demasiado largo (máx 1024). Acorta antes de cambiar.",
...
''',
        ...
        'error_repost_caption_too_long_alert': "❌ Légende trop longue ({current_length}/{max_length})! Raccourcissez avant de changer.",
        'error_mediagroup_caption_limit_alert': "❌ Limite de légende dépassée pour les messages avec plusieurs photos/vidéos",
        'error_single_media_caption_limit_alert': "❌ Légende média trop longue (max 1024). Raccourcissez avant de changer.",
...
''',
        ...
        'error_repost_caption_too_long_alert': "❌ Підпис занадто довгий ({current_length}/{max_length})! Скоротіть перед зміною типу.",
        'error_mediagroup_caption_limit_alert': "❌ Перевищено ліміт тексту для повідомлень з кількома фото/відео",
        'error_single_media_caption_limit_alert': "❌ Підпис до медіа занадто довгий (макс. 1024). Скоротіть перед зміною.",
...
''',
        ...
        'error_repost_caption_too_long_alert': "❌ Beschriftung zu lang ({current_length}/{max_length})! Kürzen Sie vor dem Typwechsel.",
        'error_mediagroup_caption_limit_alert': "❌ Textlimit für Nachrichten mit mehreren Foto/Video-Dateien überschritten",
        'error_single_media_caption_limit_alert': "❌ Medien-Beschriftung zu lang (max 1024). Kürzen Sie vor dem Wechsel.",
